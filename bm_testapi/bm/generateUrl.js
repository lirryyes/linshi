...
AesUtil.prototype.encrypt = function (salt, passPhrase, plainText) {
...
function run(plaintext) {
  //rsa加密
  //var plaintext = '{"account":"80475525","password":"3fd6ebe43dab8b6ce6d033a5da6e6ac5","rand":"8888"}';
  //var passphrase = new randUtils().gPwd();//$('#passphrase').val();
  var passphrase = "F5^t~#6H"
  //var encrypt = new JSEncrypt();
  //encrypt.setPublicKey("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDIvvJN1o5dsjSx2c8Ju0W5nbuliZuU/xJ00julQ2r4VJYnYRCzlLjYaWJvL60HJ9DiEeTo6LzgM7cq5PM9aqI6sLo8T1zuUJ7qYWYAdH1tCHXnXT9tRJ/e+TT7scv5H7mOViao28Ne+5dawVvSZtODwUT+fbSvpk9IUYJ+13jvRwIDAQAB");//公钥
  //var pswCrypt = encrypt.encrypt(passphrase);
  //console.log(pswCrypt)
  var pswCrypt = "MesmBCec5N/sZiL+uTUNeQ8kJLKb304Vq8+zRthISfJsTEMd8ps3qfcOgDXJbTKm6Q/9x/LH3oYf07kAJ/JwlW/InGMefCe7d1qua4wUfvVCv3fFpAlni/67h88MKd+ClKiPDBsn6UF0BA8f3NT1Rpf9GU7YSWf3LvNoY+vBegQ="
  console.info("pswCrypt:" + pswCrypt)

  //aes加密 
  var salt = CryptoJS.lib.WordArray.random(128 / 8).toString(CryptoJS.enc.Hex);
  console.log("salt:" + salt)
  var aesUtil = new AesUtil(128, 1000);
  var ciphertext = aesUtil.encrypt(salt, passphrase, plaintext);
  ///////////////////////////////////////////////////////////////////////////end
  params = ciphertext;
  console.log("params:" + params)
  ifLogin = false
  url = 'http://angelapi.bluemoon.com.cn/portal-admin/login/login?ifLogin=' + ifLogin + '&algorithm=PC_RSA_AES&ciphertext=' + encodeURIComponent(pswCrypt) + '&salt=' + encodeURIComponent(salt)
  data = {
